...
module cla4(
  ...
  xor #2 (p0, a[0], b[0]); and #2 (g0, a[0], b[0]);
  xor #2 (p1, a[1], b[1]); and #2 (g1, a[1], b[1]);
  xor #2 (p2, a[2], b[2]); and #2 (g2, a[2], b[2]);
  xor #2 (p3, a[3], b[3]); and #2 (g3, a[3], b[3]);
